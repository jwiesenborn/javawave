//
// musicXML sequencing blackbox
// Jesse Wiesenborn
// Version 0.3
// 4/15/2019 after work
//
...
// audio synthesizer at Diet Pumpkin Machine dot com.
//
//////////////////////////////////////////////////////////////////////////////////
...
function doComp(musicXMLpath)
{
	...
	xhttp1.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) { // Wait for document to load
			...
			xmlToArray();
			//Call pickup function to continue program 
			parsingComplete();
		}
	};
...
function getMeasureHeader() {
  return measureHeader; }
  
function getMeasureContent() {
  return measureContent; }
  
function getMeasureFooter() {
  return measureFooter; }
  
function getMeasureExtras() {
  return measureExtras; }
  
function getMeasureIndex() {
  return measureIndex; }
  
function getMeasurePartId() {
  return measurePartId; }
